...
the meaning of the current user message.

For example, if the user previously said their name
and now asks "what is my name?", classify the message
as GENERAL.

If the current message is a follow-up to a school-related
conversation, classify it as SCHOOL.
...
Use the conversation history to maintain natural
conversation continuity.

You may remember personal information explicitly
provided by the user in the conversation, such as
their name.

Do not invent personal information.

Return only the response to the current user message.
"""
...
in the current question. Do not treat conversation
history as a source of school facts.
